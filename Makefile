...
test: tests_prim.o testProbabilistes.o crible.o fonctions.o liste.o listegmp.o
	gcc -o test tests_prim.o testProbabilistes.o crible.o fonctions.o liste.o listegmp.o -lgmp
